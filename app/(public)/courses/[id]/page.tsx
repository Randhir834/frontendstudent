            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl">
                ...
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <span className={`px-3 py-1.5 text-sm font-semibold rounded-full whitespace-nowrap flex-shrink-0 shadow-md ${
              ...
              <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-purple-200">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 text-white font-bold rounded-xl transition-all hover:shadow-2xl hover:scale-105 text-lg"
                  >
